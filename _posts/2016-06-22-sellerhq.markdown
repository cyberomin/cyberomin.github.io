...
- Rating: In order to provided validated feedback into the e-commerce process as well as build a community of trust between buyers and sellers we added rating of sellers, whose data is added to product page and could be used for further cataloging in the near future.
